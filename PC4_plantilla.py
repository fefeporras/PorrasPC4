...
st.markdown("<h1 style='text-align: center;'>El diario de Fefé</h1>", unsafe_allow_html=True)
...
col1.image("IMG_2725.JPG", caption='Esta soy yo en un evento de mi trabajo.', width=300)
...
texto = """
Hola mi nombre es Maria Fernanda Porra Valdivia, tengo 19 años estudio publicidad en la universidad Católica. Me gusta grabar y editar videos, también tengo un gato que se llama simón y es super cariñoso. Me gusta mucho viajar, conocer nuevos lugares y culturas. Soy soy super social y extrovertida y actualmente trabajo como modelo y creadora de contenido.
"""
...
texto_2 = """
La verdad que si ha sido bastante complicado y confuso pero con la ayuda de Luisa hemos podido avanzar y aprender muchísimo. Al inicio no se entendía mucho ya que era totalmente nuevo pero con la practica he podido realizar muchas cosas que antes no pensé lograr.
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Presentacion de mis graficos favoritos realizados en anteriores PCs del curso pensamiento computacional para comuicaciones</h1>", unsafe_allow_html=True)
...
graficos = ['Promedio de goles anotados por Lecce', 'Promedio de tarjetas rojas recibidas como visitante por equipo','Cantidad de lenguas por familia linguistica']
...
if grafico_seleccionado == 'Promedio de goles anotados por Lecce':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Este es un grafico de una de mis PC podemos ver que hay un mayor porcentaje de goles como local por Lecce</div>", unsafe_allow_html=True)
    sidebar.image("IMG_2953.PNG", caption='Grafico de Promedio de goles anotados por Lecce', width=500)
    pass
elif grafico_seleccionado == 'Promedio de tarjetas rojas recibidas como visitante por equipo':
    sidebar.markdown("<div style='text-align: justify'>Este es un grafico de una de mis PC podemos ver que hay un mayor porcentaje de tarjetas rojas para Juventus</div>", unsafe_allow_html=True)
    sidebar.image("IMG_2955.PNG", caption='Grafico de Promedio de tarjetas rojas recibidas como visitante por equipo', width=500)
    pass
elif grafico_seleccionado == 'Cantidad de lenguas por familia linguistica':
    sidebar.markdown("<div style='text-align: justify'>Uno de los graficos que hice para una de las PC del curso</div>", unsafe_allow_html=True)
    sidebar.image("IMG_2956.PNG", caption='Grafico Cantidad de lenguas por familia linguistica', width=500)
    pass
